...
- plugin sandboxの実行隔離をOSレベルへ引き上げる
- SDKを複数言語テンプレート化し、生成コマンドを提供する
- webhook/notificationの再送戦略に重複排除IDを導入する
- examplesに適合テスト（contract test）を追加する
